...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1765160742,11122,11144}
...
os.execute('wget https://raw.githubusercontent.com/jokerrrrrrrrrr7/ZERO/main/TELETHON.lua')
os.execute('wget https://raw.githubusercontent.com/jokerrrrrrrrrr7/ZERO/main/start.lua')
dofile('TELETHON.lua')  
return false
end
if text == "راسلني" then
